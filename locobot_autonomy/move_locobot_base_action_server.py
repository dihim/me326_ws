#!/usr/bin/env python3
'''
Originally written by: Monroe Kennedy, Date: 2/17/2024
Last modified by: Yicheng Wang, Date: 3/12/2024
...
class LocobotExample(Node):
    ...
    def __init__(self):
        ...
        self.get_logger().info("LocobotExample node has been initialized")
