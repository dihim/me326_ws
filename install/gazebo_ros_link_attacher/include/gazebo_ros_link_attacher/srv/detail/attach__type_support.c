...
void Attach_Request__rosidl_typesupport_introspection_c__Attach_Request_init_function(
...
void Attach_Request__rosidl_typesupport_introspection_c__Attach_Request_fini_function(void * message_memory)
{
  gazebo_ros_link_attacher__srv__Attach_Request__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember Attach_Request__rosidl_typesupport_introspection_c__Attach_Request_message_member_array[4] = {
  {
    "model_name_1",  // name
...
static const rosidl_typesupport_introspection_c__MessageMembers Attach_Request__rosidl_typesupport_introspection_c__Attach_Request_message_members = {
  ...
  Attach_Request__rosidl_typesupport_introspection_c__Attach_Request_message_member_array,  // message members
  Attach_Request__rosidl_typesupport_introspection_c__Attach_Request_init_function,  // function to initialize message memory (memory has to be allocated)
  Attach_Request__rosidl_typesupport_introspection_c__Attach_Request_fini_function  // function to terminate message instance (will not free memory)
};

// this is not const since it must be initialized on first access
// since C does not allow non-integral compile-time constants
static rosidl_message_type_support_t Attach_Request__rosidl_typesupport_introspection_c__Attach_Request_message_type_support_handle = {
  0,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, gazebo_ros_link_attacher, srv, Attach_Request)() {
  if (!Attach_Request__rosidl_typesupport_introspection_c__Attach_Request_message_type_support_handle.typesupport_identifier) {
    Attach_Request__rosidl_typesupport_introspection_c__Attach_Request_message_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  return &Attach_Request__rosidl_typesupport_introspection_c__Attach_Request_message_type_support_handle;
}
#ifdef __cplusplus
}
#endif
...
void Attach_Response__rosidl_typesupport_introspection_c__Attach_Response_init_function(
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  // TODO(karsten1987): initializers are not yet implemented for typesupport c
  // see https://github.com/ros2/ros2/issues/397
...
void Attach_Response__rosidl_typesupport_introspection_c__Attach_Response_fini_function(void * message_memory)
{
  gazebo_ros_link_attacher__srv__Attach_Response__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember Attach_Response__rosidl_typesupport_introspection_c__Attach_Response_message_member_array[1] = {
  {
    "ok",  // name
...
static const rosidl_typesupport_introspection_c__MessageMembers Attach_Response__rosidl_typesupport_introspection_c__Attach_Response_message_members = {
  "gazebo_ros_link_attacher__srv",  // message namespace
  "Attach_Response",  // message name
  1,  // number of fields
  sizeof(gazebo_ros_link_attacher__srv__Attach_Response),
  Attach_Response__rosidl_typesupport_introspection_c__Attach_Response_message_member_array,  // message members
  Attach_Response__rosidl_typesupport_introspection_c__Attach_Response_init_function,  // function to initialize message memory (memory has to be allocated)
  Attach_Response__rosidl_typesupport_introspection_c__Attach_Response_fini_function  // function to terminate message instance (will not free memory)
};

// this is not const since it must be initialized on first access
// since C does not allow non-integral compile-time constants
static rosidl_message_type_support_t Attach_Response__rosidl_typesupport_introspection_c__Attach_Response_message_type_support_handle = {
  0,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, gazebo_ros_link_attacher, srv, Attach_Response)() {
  if (!Attach_Response__rosidl_typesupport_introspection_c__Attach_Response_message_type_support_handle.typesupport_identifier) {
    Attach_Response__rosidl_typesupport_introspection_c__Attach_Response_message_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  return &Attach_Response__rosidl_typesupport_introspection_c__Attach_Response_message_type_support_handle;
}
#ifdef __cplusplus
}
#endif
