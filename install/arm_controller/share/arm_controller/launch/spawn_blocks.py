...
def generate_launch_description():
    ...
    blue_cube_model_path_1 = PathJoinSubstitution([get_package_share_directory('arm_controller'),'model','blue_cube.urdf'])
    blue_cube_model_path_2 = PathJoinSubstitution([get_package_share_directory('arm_controller'),'model','blue_cube.urdf'])
    blue_cube_model_path_3 = PathJoinSubstitution([get_package_share_directory('arm_controller'),'model','blue_cube.urdf'])

    red_cube_model_path_1 = PathJoinSubstitution([get_package_share_directory('arm_controller'),'model','red_cube.urdf'])
    red_cube_model_path_2 = PathJoinSubstitution([get_package_share_directory('arm_controller'),'model','red_cube.urdf'])
   
    green_cube_model_path_1 = PathJoinSubstitution([get_package_share_directory('arm_controller'),'model','green_cube.urdf'])
    green_cube_model_path_2 = PathJoinSubstitution([get_package_share_directory('arm_controller'),'model','green_cube.urdf'])
   
    yellow_cube_model_path_1 = PathJoinSubstitution([get_package_share_directory('arm_controller'),'model','yellow_cube.urdf'])
    yellow_cube_model_path_2 = PathJoinSubstitution([get_package_share_directory('arm_controller'),'model','yellow_cube.urdf'])

    return LaunchDescription([
        # Declare launch arguments - positions of blocks
        #blue cube 1:
        DeclareLaunchArgument('blue_1_cube_x', default_value='0.451367'),
        DeclareLaunchArgument('blue_1_cube_y', default_value='0.09671'),
