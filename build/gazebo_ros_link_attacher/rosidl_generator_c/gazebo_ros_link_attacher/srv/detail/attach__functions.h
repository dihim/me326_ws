...
#ifndef GAZEBO_ROS_LINK_ATTACHER__SRV__DETAIL__ATTACH__FUNCTIONS_H_
#define GAZEBO_ROS_LINK_ATTACHER__SRV__DETAIL__ATTACH__FUNCTIONS_H_
...
#include "gazebo_ros_link_attacher/msg/rosidl_generator_c__visibility_control.h"
 ...
 */
ROSIDL_GENERATOR_C_PUBLIC_gazebo_ros_link_attacher
bool
 ...
 * calls
 * gazebo_ros_link_attacher__srv__Attach_Request__init().
...
/**
 * It calls
 * gazebo_ros_link_attacher__srv__Attach_Request__fini()
 ...
 * gazebo_ros_link_attacher__srv__Attach_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * gazebo_ros_link_attacher__srv__Attach_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * gazebo_ros_link_attacher__srv__Attach_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_gazebo_ros_link_attacher
...
/**
 * It calls
 * gazebo_ros_link_attacher__srv__Attach_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_gazebo_ros_link_attacher
...
/**
 * It allocates the memory for the array and calls
 * gazebo_ros_link_attacher__srv__Attach_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_gazebo_ros_link_attacher
...
/**
 * It calls
 * gazebo_ros_link_attacher__srv__Attach_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // GAZEBO_ROS_LINK_ATTACHER__SRV__DETAIL__ATTACH__FUNCTIONS_H_
